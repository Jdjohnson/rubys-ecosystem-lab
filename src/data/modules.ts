    ...
    steps: [
      ...
      },
      {
        ...
        props: {
          ...
          cards: [
            { id: 'c-oak', label: 'Oak Tree', category: 'Biotic', hint: 'Trees grow, reproduce, and need energy.', imageId: 'white-oak' },
            { id: 'c-grass', label: 'Grass', category: 'Biotic', hint: 'Grass is a living plant.', imageId: 'big-bluestem' },
            { id: 'c-algae', label: 'Algae', category: 'Biotic', hint: 'Algae is alive — it makes its own food.', imageId: 'algae' },
            { id: 'c-rabbit', label: 'Rabbit', category: 'Biotic', hint: 'Animals are always biotic.', imageId: 'eastern-cottontail' },
            { id: 'c-frog', label: 'Frog', category: 'Biotic', hint: 'Frogs are living animals.', imageId: 'bullfrog' },
            { id: 'c-hawk', label: 'Hawk', category: 'Biotic', hint: 'Hawks are living animals.', imageId: 'red-tailed-hawk' },
            { id: 'c-bass', label: 'Bass', category: 'Biotic', hint: 'Fish are living animals.', imageId: 'largemouth-bass' },
            { id: 'c-mushroom', label: 'Mushroom', category: 'Biotic', hint: 'Fungi are biotic — they\'re alive.', imageId: 'shelf-fungus' },
            { id: 'c-bacteria', label: 'Bacteria', category: 'Biotic', hint: 'Bacteria are tiny living things.' },
            { id: 'c-sunlight', label: 'Sunlight', category: 'Abiotic', hint: 'Sunlight is energy, not a living thing.', imageId: 'sunlight' },
            { id: 'c-water', label: 'Water', category: 'Abiotic', hint: 'Water is a nonliving substance.', imageId: 'water' },
            { id: 'c-air', label: 'Air', category: 'Abiotic', hint: 'Air is a mixture of gases.', imageId: 'air' },
            { id: 'c-soil', label: 'Soil', category: 'Abiotic', hint: 'Soil is nonliving material.', imageId: 'soil' },
            { id: 'c-rocks', label: 'Rocks', category: 'Abiotic', hint: 'Rocks were never alive.', imageId: 'rocks' },
            { id: 'c-temp', label: 'Temperature', category: 'Abiotic', hint: 'Temperature is a condition, not a living thing.', imageId: 'temperature' },
            { id: 'c-rain', label: 'Rain', category: 'Abiotic', hint: 'Rain is water falling from clouds.', imageId: 'rain' },
            { id: 'c-wind', label: 'Wind', category: 'Abiotic', hint: 'Wind is moving air.', imageId: 'wind' },
          ],
        },
      },
      {
    ...
    steps: [
      ...
      },
      {
        ...
        props: {
          ...
          cards: [
            { id: 'r-hawk', label: 'Red-tailed Hawk', category: 'Predator', hint: 'Does this animal hunt and kill other animals?', imageId: 'red-tailed-hawk' },
            { id: 'r-coyote', label: 'Coyote', category: 'Predator', hint: 'Does this animal hunt and kill other animals?', imageId: 'coyote' },
            { id: 'r-bass', label: 'Largemouth Bass', category: 'Predator', hint: 'This fish ambushes smaller fish and frogs.', imageId: 'largemouth-bass' },
            { id: 'r-rabbit', label: 'Cottontail Rabbit', category: 'Prey / Herbivore', hint: 'Does a rabbit hunt, or does it eat plants and get hunted?', imageId: 'eastern-cottontail' },
            { id: 'r-grasshopper', label: 'Grasshopper', category: 'Prey / Herbivore', hint: 'Think about what grasshoppers eat.', imageId: 'grasshopper' },
            { id: 'r-deer', label: 'White-tailed Deer', category: 'Prey / Herbivore', hint: 'Deer browse on plants and get hunted by coyotes.', imageId: 'white-tailed-deer' },
            { id: 'r-raccoon', label: 'Raccoon', category: 'Omnivore', hint: 'Raccoons eat berries, crayfish, and almost anything.', imageId: 'raccoon' },
            { id: 'r-turtle', label: 'Box Turtle', category: 'Omnivore', hint: 'Box turtles eat mushrooms, berries, and insects.', imageId: 'box-turtle' },
            { id: 'r-vulture', label: 'Turkey Vulture', category: 'Scavenger', hint: 'Vultures circle looking for dead animals to eat.', imageId: 'turkey-vulture' },
            { id: 'r-fungus', label: 'Shelf Fungus', category: 'Decomposer', hint: 'Fungi break down dead wood and leaves.', imageId: 'shelf-fungus' },
            { id: 'r-worm', label: 'Earthworm', category: 'Decomposer', hint: 'Worms eat dead plant matter in soil.', imageId: 'earthworm' },
          ],
        },
      },
      {
