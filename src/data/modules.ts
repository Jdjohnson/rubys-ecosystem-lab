    ...
    steps: [
      ...
      },
      {
        ...
        props: {
          ...
          cards: [
            { id: 'pt-talons', label: 'Sharp Talons', category: 'Predator Trait' },
            { id: 'pt-camouflage', label: 'Camouflage for Hunting', category: 'Predator Trait' },
            { id: 'pt-venom', label: 'Venom', category: 'Predator Trait' },
            { id: 'pt-speed', label: 'Speed to Chase Prey', category: 'Predator Trait' },
            { id: 'pt-web', label: 'Web Building', category: 'Predator Trait' },
            { id: 'pt-keen-eyes', label: 'Keen Eyesight', category: 'Predator Trait' },
            { id: 'pt-photosynthesis', label: 'Photosynthesis', category: 'Not a Predator Trait' },
            { id: 'pt-roots', label: 'Deep Roots', category: 'Not a Predator Trait' },
            { id: 'pt-bark', label: 'Thick Bark', category: 'Not a Predator Trait' },
            { id: 'pt-seeds', label: 'Spreading Seeds', category: 'Not a Predator Trait' },
          ],
        },
      },
      {
    ...
    steps: [
      ...
      },
      {
        ...
        props: {
          ...
          cards: [
            { id: 'r-hawk', label: 'Red-tailed Hawk', category: 'Predator' },
            { id: 'r-coyote', label: 'Coyote', category: 'Predator' },
            { id: 'r-bass', label: 'Largemouth Bass', category: 'Predator' },
            { id: 'r-rabbit', label: 'Cottontail Rabbit', category: 'Prey / Herbivore' },
            { id: 'r-grasshopper', label: 'Grasshopper', category: 'Prey / Herbivore' },
            { id: 'r-deer', label: 'White-tailed Deer', category: 'Prey / Herbivore' },
            { id: 'r-raccoon', label: 'Raccoon', category: 'Omnivore' },
            { id: 'r-turtle', label: 'Box Turtle', category: 'Omnivore' },
            { id: 'r-vulture', label: 'Turkey Vulture', category: 'Scavenger' },
            { id: 'r-fungus', label: 'Shelf Fungus', category: 'Decomposer' },
            { id: 'r-worm', label: 'Earthworm', category: 'Decomposer' },
          ],
        },
      },
      {
